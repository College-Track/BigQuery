--site breakdown
    ...
    --alumni
        ...
        above_80_attendance_memo AS attendance_80_2_terms_numerator,
        high_school_student_count AS high_school_student_count
...
SELECT
    ...
    --MEMO data
        ...
        SUM(above_80_attendance_memo) AS attendance_80_2_terms_numerator,
