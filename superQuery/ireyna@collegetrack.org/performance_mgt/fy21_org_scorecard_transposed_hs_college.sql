...
GROUP BY Account,measure_component,value,measure,fiscal_year
    ...
    PIVOT (MAX(value) FOR Account --pivot outcomes as row values#transposing org_scorecard_fy21 table for Data Studio usage
...
SELECT a.* EXCEPT (NORCAL,LA,CO,DC),b.NORCAL,b.LA,b.CO,b.DC
FROM transpose AS a
LEFT JOIN map_region_outcomes AS b ON a.measure_component=b.measure_component #transposing org_scorecard_fy21 table for Data Studio usage
...
INSERT INTO add_national (site_short) VALUES ('National')
        ;
--INSERT INTO add_national (region_short) VALUES ('National') ;--Add "National" as a region in region_short 
       /*
CREATE OR REPLACE TABLE `org-scorecard-286421.aggregate_data.org_scorecard_program_fy21_tranposed`
OPTIONS
    (
...
WITH national_values AS( --transform Account field, and add Grand Total to National
     SELECT 
        * EXCEPT (fiscal_year
        ...
        ,percent_6_year_grad_rate_fy21
        ,percent_mse_fy21),
        CASE WHEN site_short = 'National' THEN male_numerator/ninth_grade_denominator ELSE percent_male_fy21/100 END AS percent_male_fy21,
        CASE WHEN site_short = 'National' THEN low_income_first_gen_numerator/ninth_grade_denominator ELSE percent_low_income_first_gen_fy21/100 END AS percent_low_income_first_gen_fy21,
        CASE WHEN site_short = 'National' THEN annual_retention_numerator/annual_retention_denominator ELSE percent_annual_retention_fy21/100 END AS percent_annual_retention_fy21,
        CASE WHEN site_short = 'National' THEN mse_numerator/mse_denominator ELSE percent_male_fy21/100 END AS percent_mse_fy21,
        CASE WHEN site_short = 'National' THEN social_emotional_growth_numerator/social_emotional_growth_denominator ELSE percent_male_fy21/100 END AS percent_social_emotional_growth_fy21,
        CASE WHEN site_short = 'National' THEN above_325_gpa_seniors_numerator/senior_325_gpa_only_denominator ELSE percent_male_fy21/100 END AS percent_seniors_above_325_fy21,
        CASE WHEN site_short = 'National' THEN senior_325_gpa_and_test_ready_numerator/senior_325_gpa_and_test_ready_denominator ELSE percent_male_fy21/100 END AS percent_seniors_above_325_and_test_ready_fy21,
        CASE WHEN site_short = 'National' THEN matriculated_best_good_situational_numerator/matriculation_senior_denominator ELSE percent_male_fy21/100 END AS percent_matriculate_best_good_situational_fy21,
        CASE WHEN site_short = 'National' THEN on_track_numerator/on_track_denominator ELSE percent_male_fy21/100 END AS percent_on_track_fy21,
        CASE WHEN site_short = 'National' THEN six_yr_grad_rate_numerator/grade_rate_6_years_current_class_denom ELSE percent_male_fy21/100 END AS percent_6_year_grad_rate_fy21,
