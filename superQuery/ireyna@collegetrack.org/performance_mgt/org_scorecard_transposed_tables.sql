...
OPTIONS
    ...
    AS 
   */
 DELETE FROM `org-scorecard-286421.transposed_tables.org_scorecard_overview_all_fy`  WHERE measure_datastudio='Strategy Team representing a spectrum of identities above average nonprofit benchmarks*'
