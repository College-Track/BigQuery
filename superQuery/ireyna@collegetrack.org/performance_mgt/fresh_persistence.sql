...
SELECT 
    ...
    #academic term data
    CASE 
        WHEN academic_calendar_category_c = 'Trimester system (three terms comprise academic year)' 
        THEN 'Quarter'
        WHEN academic_calendar_category_c = 'Semester system (two terms comprise academic year)'
        THEN 'Semester'
        WHEN academic_calendar_category_c = '4-1-4 system (two semesters & one-month January interterm)'
        THEN 'Semester'
        ELSE academic_calendar_category_c
    END AS academic_calendar_category_c,
...
enrollment_indicators AS (
    ...
    --Quarter
    CASE 
        WHEN academic_calendar_category_c = 'Quarter' 
    ...
    --Semester
    CASE 
        WHEN academic_calendar_category_c = 'Semester' 
        AND indicator_college_matriculation_c = '4-year'
        AND term_c = 'Spring' 
        AND enrolled_in_a_4_year_college_c = TRUE
        AND current_enrollment_type ='enrolled_in_4_yr_current'
