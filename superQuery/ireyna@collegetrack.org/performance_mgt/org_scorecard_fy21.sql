...
SELECT 
    ...
    CASE WHEN region_abrev = 'NOR CAL' AND site_or_region_abbrev IS NULL THEN SUM(male_numerator) OVER () ELSE male_numerator END AS male_numerator,
...
WHERE site_or_region_abbrev = "NORCAL" OR region_abrev = 'NOR CAL'
)
