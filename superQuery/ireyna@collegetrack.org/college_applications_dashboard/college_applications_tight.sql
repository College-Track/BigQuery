...
CREATE OR REPLACE TABLE `data-studio-260217.college_applications.college_application_filtered_table_tight`
OPTIONS
    (
...
SELECT
    ...
    app.application_status_c AS application_status_app,
...
SELECT 
    ...
    CASE 
        WHEN application_status <> 'No College Application' THEN application_status_app
