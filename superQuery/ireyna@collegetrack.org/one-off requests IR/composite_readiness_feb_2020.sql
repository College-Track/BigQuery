...
SELECT A_T.contact_id AS contact_id,full_name_c,act_composite_score_c, sat_total_score_c,version_c, status_c, test_date_c, student_audit_status_c AS ct_status_at, AT_grade_c, 
...
WHERE (sat_total_score_c = 
    ...
    AND test_date_c <= '2020-02-28'
    AND AT_grade_c = '11th Grade'
    AND high_school_class_c = '2021')
    )
...
AND AT_grade_c = '11th Grade'
AND high_school_class_c = '2021'
AND ct_status_at= 'Current CT HS Student'
