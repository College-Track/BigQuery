...
SELECT * 
FROM
    (SELECT annual_fundraising_target,__Capacty FROM hr_financial_sustainability_hs_capacity)
UNPIVOT INCLUDE NULLS 
    ( (annual_fundraising_target,__Capacty) FOR Outcome
        IN (annual_fundraising_target,__Capacty)
    ) AS test
