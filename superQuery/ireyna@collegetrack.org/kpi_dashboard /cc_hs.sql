SELECT student_c, SUM(Attendance_Numerator_excluding_make_up_c) AS attendance_numerator, SUM(Attendance_Denominator_c) AS attendance_denominator, Cancelled_c
    ...
    AND global_academic_semester_c IN ('a3646000000dMXnAAM','a3646000000dMXoAAM','a3646000000dMXpAAM') #Fall 2020-21, Spring 2020-21
    GROUP BY student_c,Attendance_Numerator_excluding_make_up_c,Attendance_Denominator_c, Cancelled_c