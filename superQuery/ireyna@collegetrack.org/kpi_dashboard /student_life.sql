...
FROM
    ...
    LEFT JOIN aggregate_mse_reporting_group AS mse_grp ON mse_grp.site_short = d.site_short AND mse_grp.Ethnic_background_c = d.Ethnic_background_c AND mse_grp.gender_c=mse_kpi.gender_c
