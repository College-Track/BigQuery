CREATE OR REPLACE TABLE `data-studio-260217.fit_type_pipeline.fit_type_applied`
OPTIONS
    (
    description= "This table pulls college application, academic term Fall Year 1 data, and includes academic and demographic info. Table only includes students with application status of 'applied'"
    )
AS
