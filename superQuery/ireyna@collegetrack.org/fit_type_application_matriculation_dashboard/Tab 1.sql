...
WITH college_application_AT AS (
  SELECT
    ...
    A_T.AT_Name,
    #academic term name
    A_T.AT_RecordType_ID,
    #AT record type
    A_T.AT_Record_Type_Name,
    #academic record type (HS, college)
    A_T.AY_End_Date,
    A_T.AY_Start_Date,
    A_T.AY_Name,
    ...
    A_T.Current_AS__c,
    #current AT
    A_T.Current_Academic_Semester__c,
    #current AT on contact,
    A_T.Current_CCA_Viewing__c,
    A_T.Current_CC_Advisor__c,
    A_T.Current_CT_Status__c,
    A_T.Current_Enrollment_Status__c,
    #from contact
    A_T.Current_HS_CT_Coach__c,
    #from contact
    A_T.Current_Major__c,
    #from contact
    A_T.Current_Major_specific__c,
    #from contact
    A_T.Current_Minor__c,
    #from contact
    A_T.Current_School_Type__c,
    #from contact
    A_T.Current_School__c,
    #from contact
    A_T.Current_Second_Major__c,
    #from contact
    A_T.Current_employment_other__c,
    #from contact
    A_T.Current_employment_type__c,
    #from contact
    ...
    A_T.Indicator_Years_Since_HS_Graduation__c,
    #contact
    ...
    A_T.Major_4Year_Degree_Earned__c,
    #contact
    A_T.Major_Other__c,
    A_T.Major__c,
    A_T.Major_other_4Year_Degree_Earned__c,
    #contact,
    ...
    A_T.Prev_Prev_As__c,
    #indicator: previous previous at,
    A_T.Previous_AS__c,
    #indicator: previous at,
    ...
    A_T.of_PS_Academic_Term_Records__c,
    #on AT. number of PS AT records with Enrollment Status of part-time or full-time
    A_T.of_Post_Secondary_AS__c,
    #on contact. number of PS AT records with Enrollment Status of part-time or full-time,
    A_T.region,
    A_T.region_short,
    A_T.site_short,
    ...
    CA.Common_App_Accepted_at_School__c,
    #from college account
    ...
    CA.Strategic_Type__c AS match_type,
    #match type
