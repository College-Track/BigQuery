...
SELECT
    app.*
        EXCEPT (school_name_enrolled, school_type_enrolled,Indicator_Completed_CT_HS_Program__c),
    term.*
        EXCEPT (Full_Name__c,High_School_Class__c,site_full,site_short,region_full,region_short,Contact_Id, Indicator_Years_Since_HS_Grad_to_Date__c,
    Indicator_College_Matriculation__c,Situational_Fit_Type__c, Situational_Best_Fit_Context__c),
