WITH calculate_metrics AS(
  SELECT
    *,
    ...
    CASE
      WHEN Current_Enrollment_Status__c = "Full-time" THEN 1
      ELSE 0
    ...
    CASE
      WHEN PS_Internships__c > 0 THEN 1
      ELSE 0
    ...
    CASE
      WHEN Fit_Type__c = "Best Fit" THEN 1
      WHEN Fit_Type__c = "Situational Best Fit" THEN 1
      ELSE 0
