...
WHERE  Workshop_Global_Academic_Semester__c = 'Fall 2020-21' AND GPA_Bucket = "3.5 or Greater" AND Date__c < "2020-08-25" AND Workshop_Dosage_Type__c LIKE "%Student Life%"
ORDER BY WSA_ID