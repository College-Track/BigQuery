WITH gather_data AS (
  SELECT
    ...
    CASE
      ...
      WHEN grade_c = 'Year 3' THEN 7
      WHEN grade_c = 'Year 4' THEN 8
      WHEN grade_c = 'Year 5' THEN 9
      WHEN grade_c = 'Year 6' THEN 10
      WHEN grade_c = 'Year 7' THEN 11
