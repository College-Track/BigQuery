...
(
    ...
    IFNULL(bb_balance.Finance_BB_Balance,0) + IFNULL(bb_march_disburse_add.bb_add_to_balance,0) - IFNULL(bb_march_earn_minus.bb_minus_from_balance,0) AS adj_bb_balance,
