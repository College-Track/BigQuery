...
(
    ...
    site_sort,
    clean_dosage_type,
    Max(Total_duration_min) AS dosage_type_duration_req,
    SUM(at_total_mins) AS dosage_type_total_workshops_duration
    ...
    *,
    CASE
        WHEN dosage_type_total_workshops_duration < dosage_type_duration_req THEN 0
        ELSE 1
